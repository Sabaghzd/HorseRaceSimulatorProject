...
public class AiGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(255, 252, 199));
    ...
    public void setLabelText(String text) {
        setMultiLineLabelText(jLabel2, text, 400);
    }
    
    public static void setMultiLineLabelText(JLabel label, String text, int maxWidth) {
